...
s_run_list = pw.generate_runs(settings, 10)
stats, all_values = pw.func_on_runs(au.run_estimators, s_run_list, estimator_list)
print(stats)
...
stats, all_values = pw.func_on_runs(au.run_estimators, d_run_list, estimator_list)
print(stats)
